...
import com.sensedia.agillitas.api.v1.client.auth.OAuth;
import com.sensedia.agillitas.api.v1.client.auth.OAuth.AccessTokenListener;
import com.sensedia.agillitas.api.v1.client.auth.OAuthFlow;
...
public class ApiClient {
  ...
  public void createDefaultAdapter() {
    ...
    String baseUrl = "https://api-visa.sensedia.com/sandbox/visa/agillitas/v1";
    if(!baseUrl.endsWith("/"))
      baseUrl = baseUrl + "/";
